...
Image layers are configured in `config.kitchen-sink.json`:
```json
{
  "name": "Image - GeoTIFF - Single Band (Optional)",
  "type": "image",
  "url": "Missions/Kitchen-Sink/Layers/Images/sample.tif",
  "bands": 1,
  "colormap": "viridis"
}
```
...
- Images are **optional** for Kitchen Sink demo
