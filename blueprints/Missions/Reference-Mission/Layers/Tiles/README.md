...
Demonstrate local tile serving capabilities in MMGIS. The Reference Mission configuration includes placeholder tile layers that reference this directory.
...
To use local tiles, they're already configured in `config.reference-mission.json`:
```json
{
...
- Tiles are **optional** for Reference Mission demo
