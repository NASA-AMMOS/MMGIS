...
This directory is for **optional** local 3D model files. By default, the Reference Mission configuration uses **external URLs** to NASA 3D Resources.
...
The Reference Mission config uses **external URLs** by default:
...
3. Update config URL: `"url": "Missions/Reference-Mission/Layers/Models/curiosity_rover.gltf"`
...
```json
{
  ...
  "type": "model",
  "url": "Missions/Reference-Mission/Layers/Models/rover.gltf",
