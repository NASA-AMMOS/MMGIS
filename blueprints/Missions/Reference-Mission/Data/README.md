...
Tools are configured in `config.reference-mission.json` with placeholder paths:
...
```json
{
  "name": "Measure",
  "variables": {
    "dem": "Missions/Reference-Mission/Data/elevation.tif"
  }
}
```
...
```json
{
  ...
  "variables": {
    "data": [
      {
        "name": "SF Bay DEM",
        "demtileurl": "Missions/Reference-Mission/Data/dem_tiles/{z}/{x}/{y}.png",
        "minZoom": 10,
        "maxNativeZoom": 16
      }
    ]
...
## Recommended for Reference Mission (SF Bay Area)
...
- Data files are **optional** for Reference Mission demo
