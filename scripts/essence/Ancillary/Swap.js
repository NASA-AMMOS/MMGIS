...
define([
    ...
    // prettier-ignore
    var markup = [
    "<div id='swap' style='width: 100%; height: 100%; display: flex; flex-flow: column; border-left: 1px solid #26a8ff;'>",
      "<div style='display: flex; justify-content: space-between; border-bottom: 2px solid #3a3a3a; height: 30px; font-size: 14px; padding-left: 8px; line-height: 30px; background: #26a8ff;'>",
        "<div>Swap Mission</div>",
        "<div id='swapToHost' style='width: 28px; line-height: 28px; text-align: center; cursor: pointer;'><i class='mdi mdi-home-circle mdi-18px'></i></div>",
      "</div>",
        ...
        function makeMissionList(missionList, filterString) {
            ...
            for (var m in missionList) {
                if (
                    ...
                    //mark
                    if (
                        typeof $('#swapMissionName_' + m).markRegExp ===
                        'function'
                    )
