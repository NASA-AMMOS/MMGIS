define(['jquery', 'd3', 'Map_', 'Formulae_'], function($, d3, Map_, F_) {
    var ScaleBox = {
        box: null,
        popup: null,
        ...
        init: function() {
            ...
            // prettier-ignore
            this.popup.html(
        "<div class='center aligned middle aligned ui padded grid'>" +
          "<div class='ui mini right labeled input' style='padding: 0; pointer-events: auto;'>" +
            "<input id='scaleboxX' type='text' placeholder='w' size='4'>" +
            "<div class='ui basic label' style='padding-left: 4px; padding-right: 4px;'>" +
              "m" +
            "</div>" +
          "</div>" +
          "<p style='font-size: 20px; padding: 0px 3px 0px 3px; margin: 0; color: #161616;'>&times;</p>" +
          "<div class='ui mini right labeled input' style='padding: 0; pointer-events: auto;'>" +
            "<input id='scaleboxY' type='text' placeholder='h' size='4'>" +
            "<div class='ui basic label' style='padding-left: 4px; padding-right: 4px;'>" +
              "m" +
            "</div>" +
          "</div>" +
