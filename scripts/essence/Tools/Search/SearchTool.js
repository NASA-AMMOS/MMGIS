define([
    ...
    // prettier-ignore
    var markup = [
  "<div id='searchTool' class='sixteen wide column'>",
    "<p style='display: inline-block; padding-right: 8px;'>Search</p>",
    "<select id='searchToolType' class='ui dropdown short'>",
    "</select>",
    "<p style='display: inline-block; padding-left: 8px;'>for</p>",
    "<div class='ui-widget' style='display: inline-block; padding: 8px;'>",
      "<input id='auto_search' style='color: #111;'></input>",
    "</div>",
    "<p style='display: inline-block; padding-left: 8px;'>and</p>",
