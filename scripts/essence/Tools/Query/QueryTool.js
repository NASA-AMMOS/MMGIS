                ...
                if (
                    ...
                    if (thisDrawing.drawing) {
                        ...
                        if (thisDrawing.drawingType === 'point') {
                            Map_.rmNotNull(
                                L_.layersGroup['QueryToolPointBuffer']
                            )
        ...
        if (userId && token) {
                ...
                // If icon type is intersection
                    ...
                    $.ajax({
                        ...
                        success: function(layers) {
                            if (!layers) {
                                console.log(
                                    'There is no result for the layers!'
                                )
                            } else {
                                ...
                                d3.select('#' + parentID)
                                    ...
                                    .attr(
                                        'class',
                                        'mdi mdi-lead-pencil mdi-24px'
                                    )
                                    .attr(
                                        'id',
                                        parentID + '-drawing-tool-polygon'
                                    )
            ...
            function createSelectedButton(
                ...
                d3.select('#' + P_ID)
                    ...
                    .attr(
                        'id',
                        Inst_Name + '-geom-' + Icon_Type + '-' + Inst_ID
                    )
            ...
            function createGeometryComponent(
                ...
                spatialIcons.forEach(function(icon) {
                    d3.select(
                        '#' + inst_name + '-geom-geomIcons-group-' + inst_id
                    )
                        .append('i')
            ...
            $(document).ready(function() {
                                    ...
                                    case 'line': // A line buffer
                                        ...
                                        let lineCoords = function() {
                                            if (
                                                ...
                                                // Set the query run flag to true
                                                runQuery = true
                                                return QueryTool.Draw
                                                    .drawingPoly._latlngs
                                            } else {
                                                // Set the query run flag to false
                                                runQuery = false
                ...
                $('#queryTool_saveQuery').on('click', event => {
                    ...
                    if (idParts.indexOf('save') > -1 && storeQuery === true) {
                        ...
                        let query_name = $(
                            '#queryTool_saveQuery_input_name'
                        ).val()
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        while (
                            ...
                            endIndex =
                                data.description.substr(1).indexOf(']') + 1
                            ...
                            coordsStr = JSON.stringify(
                                JSON.parse('[' + coordsStr + ']').map(function(
                                    v
                                ) {
                                    return {
                                        lat: v.lat.toFixed(8),
                        ...
                        d3.select('#loadQuery-queryExe-' + selectQuery_id)
                            ...
                            .on('click', function() {
                                $.ajax({
                                    ...
                                    success: function() {
                                        alert(
                                            'The query is removed from database!'
                                        )
                                        $(
