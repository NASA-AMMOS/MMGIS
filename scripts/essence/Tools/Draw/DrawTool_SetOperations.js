define([
    ...
    'CursorInfo',
    'mark',
], function($, d3, F_, L_, Globe_, Map_, Viewer_, UserInterface_, CursorInfo) {
    var DrawTool = null
    var SetOperations = {
        activeTab: null,
        lastSplitLine: null,
        init: function(tool) {
            ...
            DrawTool.addSetOperationsEvents =
                SetOperations.addSetOperationsEvents
        },
        ...
        addSetOperationsEvents: function() {
            $('.drawToolContextMenuTabButtonSO').on('click', function() {
                $('.drawToolContextMenuTabButtonSO.active').removeClass(
                    'active'
                )
            ...
            $('.drawToolContextMenuTabSOMerge ul li').on(
                'mouseenter',
                function() {
