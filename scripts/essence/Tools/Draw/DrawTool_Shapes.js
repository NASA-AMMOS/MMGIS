    ...
    var Shapes = {
        ...
        populateShapes: function (fileId, selectedFeatureIds) {
            ...
            function addShapeToList(shape, file, layer, index, layerId) {
                ...
                let activeClass = ''
                if (stillActive.indexOf(shapeLiId) != -1)
                    activeClass = ' active'
                        ...
                        (function (layer, index) {
                            return function (event) {
                                ...
                                if (
                                    ...
                                    p =
                                        l._layers[Object.keys(l._layers)[0]]
                                            .feature.properties
            ...
            $('.drawToolShapeLi').on('mouseenter', function () {
                ...
                if (typeof L_.layersGroup[layer][index].setStyle === 'function')
                    ...
                    L_.layersGroup[layer][index].hasOwnProperty('_layers')
                ) {
                    //Arrow
            ...
            if (
                ...
                for (var i = 0; i < selectedFeatureIds.length; i++) {
                    ...
                    if (item.length > 0) {
                        var shape =
                            L_.layersGroup[item.attr('layer')][
                                item.attr('index')
                            ]
                        if (shape.hasOwnProperty('_layers'))
                            shape._layers[
                                Object.keys(shape._layers)[0]
                            ].fireEvent('click')
                        else shape.fireEvent('click')
                    }
