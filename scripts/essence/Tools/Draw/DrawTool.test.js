        ...
        tests: [
            ...
            },
            {
                ...
                test: function(c) {
                    ...
                    c(
                        ...
                        $(
                            "#drawToolDrawSettingsTier > div[value='off']"
                        ).hasClass('active')
                    )
            ...
            },
            {
                ...
                test: function(c) {
                    ...
                    var oldLength = L_.layersGroup[layerId].filter(Boolean)
                        .length
                    Test_.mapEvent('click')
                    Test_.fireEvent('mousemove', 300, 300)
                    Test.tool.drawing.line.shape._latlngs = [
            ...
            },
            {
                ...
                test: function(c) {
                    ...
                    c(
                        'Group context menu',
                        $('.drawToolContextMenuHeaderCount > span').text() ===
                            'x3'
                    )
