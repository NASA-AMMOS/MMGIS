define([
    ...
    var DrawTool = {
        ...
        highlightGradient:
            'linear-gradient( to left, #26ff67, rgb(127,255,0) )',
        noteIcon: null,
                    ...
                    if (data) {
                        ...
                        for (var i = 0; i < DrawTool.intents.length; i++) {
                            for (var j = data.body.length - 1; j >= 0; j--) {
                                if (
                                    data.body[j].intent == DrawTool.intents[i]
                                ) {
    ...
    function interfaceWithMMGIS() {
        ...
        $('#drawToolFilterDropdownAll').html(
            DrawTool.intentNameMapping.all + 's'
        )
        $('#drawToolFilterDropdownROI').html(
            DrawTool.intentNameMapping.roi + 's'
        )
        ...
        $('#drawToolShapesCopyGo').on('click', function() {
            ...
            var filename =
                files_i !== -1 ? DrawTool.files[files_i].file_name : null
            ...
            if (commonIntents) {
                ...
                $('.drawToolShapeLi').each(function(i, elm) {
                    if ($(elm).hasClass('active')) {
                        ...
                        //Because leaflet and postgis have inverted lat lngs
                        if (
                            intent == 'point' &&
