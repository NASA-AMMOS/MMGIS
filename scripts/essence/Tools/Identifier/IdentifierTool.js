...
define([
    ...
    'Viewer_',
    'CursorInfo',
], function($, d3, F_, L_, Globe_, Map_, Viewer_, CursorInfo) {
                        ...
                        queryDataValue(
                            ...
                            (function(pxRGBA, i) {
                                return function(value) {
                                    ...
                                    $(
                                        '#identifierToolIdPixelCursorInfo_' + i
                                    ).html(htmlValues)
                                }
                            })(pxRGBA, i)
                        )
    ...
    function queryDataValue(url, lng, lat, numBands, callback) {
        ...
        calls.api(
            ...
            function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'private/api/getbandsREG.php',
                    data: {
                        type: 'band',
                        x: lat,
                        y: lng,
