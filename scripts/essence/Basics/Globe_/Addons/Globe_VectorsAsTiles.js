            ...
            if (scaleFactor < 128) {
                for (let v = 0; v < vt.length; v++) {
                    ...
                    for (let l in vt[v].layers) {
                        ...
                        let fillColor = 
                            vl.options.fillColor || 'rgb(0,0,0)';
                            fillColor = (vl.feature.properties.style ? vl.feature.properties.style.fillColor : fillColor ) || fillColor
                        
                        let color = (vl.feature.properties.style ? vl.feature.properties.style.color : vl.options.color ) || vl.options.color
                        
                        let weight = (vl.feature.properties.style ? vl.feature.properties.style.weight : vl.options.weight ) || vl.options.weight

                        let radius = (vl.feature.properties.style ? vl.feature.properties.style.radius : vl.options.radius ) || vl.options.radius

                        let fillOpacity =
                            vl.options.fillOpacity != undefined
                                ? vl.options.fillOpacity
                                : 0.4;
                            fillOpacity = (vl.feature.properties.style ? vl.feature.properties.style.fillOpacity : fillOpacity ) || fillOpacity
