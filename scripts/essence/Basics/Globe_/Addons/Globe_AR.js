define([
    ...
    'UserInterface_',
    'nipple',
], function(THREE, d3, F_, VRControls, ThreeAR, UserInterface_, nipple) {
    var Globe_AR = {
        G_: null,
        scene: null,
        overscene: null,
        ...
        update: function() {
            ...
            Globe_AR.scene.position.x =
                Globe_AR.scenescale *
                (Globe_AR.pos.x - Globe_AR.camera.position.x)
            Globe_AR.scene.position.y =
                Globe_AR.scenescale *
                (Globe_AR.pos.y - Globe_AR.camera.position.y)
            Globe_AR.scene.position.z =
                Globe_AR.scenescale *
                (Globe_AR.pos.z - Globe_AR.camera.position.z)
        ...
        makeUI: function() {
            ...
            */
                ...
                if (Globe_AR.placeOnSurfaceMode) {
                    ...
                    d3.select('#_AR_placeButton').style(
                        'background',
                        'transparent'
                    )
                    d3.select('#_AR_nippleScreenLeft').style(
                    ...
                    d3.select('#_AR_scaleLeft').style(
                        'pointer-events',
                        'inherit'
                    )
                    d3.select('#_AR_scaleLeft').style('opacity', '1')
                    d3.select('#_AR_zoomRight').style(
                        'pointer-events',
                        'inherit'
                    )
