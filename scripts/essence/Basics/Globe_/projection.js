    ...
    var projection = {
        ...
        */
        ...
        tile2long: function(x, z, parms) {
            ...
            switch (parms.projection || this.projection) {
                ...
                case 'stereographic(N)':
                    ...
                    return (
                        (this.centerLon + Math.atan2(sx, -sy)) *
                            (180 / Math.PI) +
                        this.stereNOffset[0]
                    )
        ...
        vector3ToLonLatOLD: function(xyz) {
            ...
            var theta =
                Math.acos(
                    xyz.y / (this.radiusOfPlanetMajor / this.radiusScale)
                ) *
                    (180 / Math.PI) -
                90
        ...
        vector3ToLonLat: function(xyz) {
            ...
            var phi =
                Math.atan((xyz.z + Math.pow(this.ep, 2) * Z0) / r) *
                (180 / Math.PI)
