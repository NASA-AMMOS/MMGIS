...
function buildRegistry() {
  ...
  return {
    ...
    uiProfiles: {
      ...
      threshold_highlight: { kind: "render_threshold_highlight" },
      highlight_toggle: { kind: "highlight_toggle" },
      highlight_clear: { kind: "highlight_clear" },
      highlight_opacity: { kind: "highlight_opacity" },
