...
;(function (factory) {
    ...
    THREE.GLTFLoader = (function () {
            ...
            return {
                ...
                refreshUniforms: function (
                    ...
                    if (material.envMap) {
                        ...
                        uniforms.flipEnvMap.value = material.envMap
                            .isCubeTexture
                            ? -1
                            : 1
        ...
        GLTFCubicSplineInterpolant.prototype.copySampleValue_ = function (
            index
        ) {
            ...
            for (
                ...
                if (nodeDef.mesh !== undefined) {
                    if (meshReferences[nodeDef.mesh] === undefined) {
                        meshReferences[nodeDef.mesh] = meshUses[
                            nodeDef.mesh
                        ] = 0
                    }
