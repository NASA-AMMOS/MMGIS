        ...
        $(
            ...
            let markup = [
                    "<div id='drawToolDrawFilesListElemContextMenu' style='top: " +
                        ...
                        '<ul>',
                            (!isHead && L_.Coordinates.mainType != 'll') ? "<li id='cmExportGeoJSON' convert='true'><i class='mdi mdi-download mdi-14px'></i>Export GeoJSON (converted)</li>" : "",
                            !isHead ? "<li id='cmExportSourceGeoJSON' convert='true'><i class='mdi mdi-download mdi-14px'></i>Export GeoJSON</li>" : "",
