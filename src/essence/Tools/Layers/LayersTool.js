...
function interfaceWithMMGIS(fromInit) {
    ...
    //Export KML
    $('.layersToolExportKML').on('click', function () {
        const li = $(this).parent().parent().parent().parent()
    ...
    //Export Source KML
    $('.layersToolExportSourceKML').on('click', function () {
        const li = $(this).parent().parent().parent().parent()
            ...
            ),
            {
                ...
                timestamp:
                    layerData.time?.enabled === true
                        ...
                        : null,
                documentName: `${layerDisplayName}`,
                documentDescription: 'Generated by MMGIS',
                simplestyle: true,
            }
        )
        F_.downloadObject(kml, layerDisplayName, '.xml', 'xml')
    })
    //Refresh settings
