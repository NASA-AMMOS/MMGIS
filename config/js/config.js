...
function makeLayerBarAndModal( d, level ) {
  ...
  var barColor;
  var headerSel = "", tileSel = "", pointSel = "", vectorSel = "", modelSel = "";
  switch( d.type ) {
    case "header": barColor = "#2f8989"; headerSel = "selected";
      break;
    case "tile": barColor = "#558b2f"; tileSel = "selected";
      break;
    case "point": barColor = "#892f45"; pointSel = "selected";
      break;
    case "vector": barColor = "#895c2f"; vectorSel = "selected";
      break;
    case "model": barColor = "#552f89"; modelSel = "selected";
  }
