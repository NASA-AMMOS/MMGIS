...
For patch contributions, see our [Developer Documentation](https://github.com/NASA-AMMOS/MMGIS/wiki) for more details on how to set up your local environment, to best contribute to our project. 
...
- [Discussion board](https://github.com/NASA-AMMOS/MMGIS/discussions) - a permanently archived place to hold conversations related to our project, and to propose as well as show+tell topics to the contributor team. This resource can be searched for old discussions.
...
- **Check for duplicates** - there may be a new feature issue already describing your issue, so check the [issue tracking system](https://github.com/NASA-AMMOS/MMGIS/issues) first
...
⚠️ It's **highly** advised that you take a look at our [issue tracking system](https://github.com/NASA-AMMOS/MMGIS/issues) before considering any code contributions. Here's some guidelines:
...
- Hosted documentation
  - [Wiki Main-page](https://github.com/NASA-AMMOS/MMGIS/wiki)
- Discussion Boards
  - [Discussions](https://github.com/NASA-AMMOS/MMGIS/discussions)
...
- Answer open questions in our [discussion forum](https://github.com/NASA-AMMOS/MMGIS/discussions)
